...
<body>
        ...
        <div class="row gx-4 d-none d-lg-flex">
            <div class="col-lg-6 text-start">
                <div class="h-100 d-inline-flex align-items-center py-3 me-4">
                    ...
                    <small><b>Welcome to Rotex Engineers</b></small>
                </div>
            ...
            <div class="col-lg-6 text-end">
                <div class="h-100 d-inline-flex align-items-center py-3 me-4">
                    ...
                    <small>+91 9850237399</small>
                </div>
                <div class="h-100 d-inline-flex align-items-center py-3">
                    <div class="btn-sm-square rounded-circle bg-primary me-2">
                        <small class="fa fa-envelope-open text-white"></small>
                    </div>
                    <small>rotexengineers@gmail.com</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
        <a href="index.php" class="navbar-brand d-flex align-items-center">
            <img src="img/icon/nicon.jpg" width="170px"  alt="">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                <div class="nav-item dropdown">
                    <a href="product.php" class="nav-link nav-item dropdown-toggle" data-bs-toggle="dropdown">Materials</a>
                    <div class="dropdown-menu rounded-0 rounded-bottom m-0">
                        <a href="allloy_steel_fasteners.php" class="dropdown-item">Alloy Steel Fasteners</a><hr style="margin:0;" class="dropdown-divider">
                        <a href="astm_a193_grade_b7_fasteners.php" class="dropdown-item">ASTM A193 Grade B7 Fasteners</a><hr style="margin:0;" class="dropdown-divider">
                        <a href="astm_a193_grade_b16_fasteners.php" class="dropdown-item">ASTM A193 Grade B16 Fasteners</a><hr style="margin:0;" class="dropdown-divider">
                        <a href="carbon_steel_fasteners.php" class="dropdown-item">Carbon Steel Fasteners</a><hr style="margin:0;" class="dropdown-divider">
                        <a href="duplex_steel_fasteners.php" class="dropdown-item">Duplex Steel Fasteners</a><hr style="margin:0;" class="dropdown-divider">
                        <a href="inconel_fasteners.php" class="dropdown-item">Inconel Fasteners</a><hr style="margin:0;" class="dropdown-divider">
                        <a href="High_tensile_fasteners.php" class="dropdown-item">High Tensile Fasteners</a><hr style="margin:0;" class="dropdown-divider">
                        <a href="mild_steel_fasteners.php" class="dropdown-item">Mild Steel Fasteners</a><hr style="margin:0;" class="dropdown-divider">
                        <a href="monel_fasteners.php" class="dropdown-item">Monel Fasteners</a><hr style="margin:0;" class="dropdown-divider">
                        <a href="stainless_steel_fasteners.php" class="dropdown-item">Stainless Steel Fasteners</a>                       
                    </div>
                </div>
