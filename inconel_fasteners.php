...
<div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Inconel Fasteners</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="product.php">Products</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Inconel Fasteners</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <table class=" table table-bordered ">
                        <tbody>
                            <tr>
                                ...
                                <td><center>ASTM B166, B446 / ASME SB166, SB446</center></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><center>600 / 601 / 625 / 718</center></td>
                            </tr>
