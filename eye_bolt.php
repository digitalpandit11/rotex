...
<div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Eye  Bolt</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="bolts.php">Bolts</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Eye  Bolt</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-fluid bg-light overflow-hidden my-5 px-lg-5">
        <div class="container about px-lg-0">
            <div class="row g-0 mx-lg-0">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img class="mt-2" src="img/product1/Eyebolts/EB2.webp" width="100%" alt="">
                    </div>
                    <div class="col-md-6">
                        <img class="mt-2" src="img/product1/Eyebolts/EB8.webp" width="100%" alt="">
                    </div>
                </div><br><br>
                ...
                <ul>
                    <li>
                    <p class="mb-2"><b>Eye Bolt Standard:</b> GB DIN ISO</p>
                    </li>
                    <li>
                    <p class="mb-2"><b>Eye Bolt Sizes:</b>M64</p>
                    </li>
                    <li>
