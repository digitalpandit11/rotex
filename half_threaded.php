...
<div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Half threaded Stud</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="product.php">Products</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Half threaded Stud</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-9 ps-lg-2" style="min-height: 400px;">
                    ...
                    <table class=" table table-bordered ">
                        <tbody>
                            <tr>
                                <th><center>Fully Threaded Rods of Standard</center></th>
                                <td><center>Din 975, Din 976 ASTM, DIN, BS and all International Standards</center></td>
                            </tr>
                            <tr>
                                <th><center>Thread size of Stainless Steel Threaded Rods</center></th>
                                <td><center>M38, M16, M5, M2, M45, M12, M72, M48, M6, M8, M56, M22, M14</center></td>
                            </tr>
                            <tr>
                                <th><center>Threaded Rods length</center></th>
                                <td><center>12, 360, 90, 200, 180, 25, 70, 150, 440, 220, 120, 380, 35, 80, 85, 400, 420, 100, 55, 320, 170, 280, 190, 22, 30, 300, 50, 140, 60, 260, 240, 500, 18, 40, 340, 45, 130, 65, 110, 95, 16, 20, 14, 75</center></td>
                            </tr>
                        </tbody>
                    </table>
                    </div>        
