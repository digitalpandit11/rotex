...
<div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Fender Washers</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="product.php">Products</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Fender Washers</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-9 ps-lg-2" style="min-height: 400px;">
                    ...
                    <table class=" table table-bordered ">
                        <tbody>
                            <tr>
                                <th><center>Specifications of Plain Washers</center></th>
                                <th><center>ASME SA193 ASTM A193</center></th>
                            </tr>
                            <tr>
                                <th><center>DIN125 Flat Washer Standard</center></th>
                                <td><center>ASTM, DIN, BS and all International Standards</center></td>
                            </tr>
                            <tr>
                                <th><center>Length of Stainless Steel plain Washers</center></th>
                                <td><center>M02 to M33</center></td>
                            </tr>
                            <tr>
                                <th><center>Size of Iron Flat Washer</center></th>
