...
<div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Threaded Rod</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="product.php">Products</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Threaded Rod</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container about px-lg-0">
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-9 ps-lg-2" style="min-height: 400px;">
                    ...
                    <table class=" table table-bordered ">
                        <tbody>
                            <tr>
                                ...
                                <td><center>304, 304L, 316, 316L, B8, B8M, A2, A4</center></td>
                            </tr>
                            <tr>
                                <th><center>Condition</center></th>
                                <td><center>Cold Drawn, Threading</center></td>
                            </tr>
                            <tr>
                                <th><center>Diameter</center></th>
                                <td><center>Metric M6 to M48, Inches – 1/4’’ to 2’’</center></td>
                            </tr>
                            <tr>
                                <th><center>Threading Method</center></th>
                                <td><center>Thread Rolling</center></td>
                            </tr>
                            <tr>
                                <th><center>Thread Condition</center></th>
                                <td><center>Fully Threaded</center></td>
                            </tr>
                            <tr>
                                <th><center>Thread Type</center></th>
                                <td><center>Class-1 & Class-2 ( Low and High Tensile Threaded Rod)</center></td>
                            </tr>
                            <tr>
                                <th><center>Length</center></th>
                                <td><center>2/3/4 meter(6/12ft )</center></td>
                            </tr>
                            <tr>
                                <th><center>Length Tolerance</center></th>
                                <td><center>-0 / +200 mm (-0”/+ 8” )</center></td>
                            </tr>
                        </tbody>
                    </table>
                    </div>     
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <img src="img/product/threaded/Stud-Full-Threaded.jpg" alt="">
                            <br><br><center><h4>Stud Full Threaded</h4></center>
                        </div>
                        <div class="col-lg-3">
                            <img src="img/product/threaded/Double-Ended-Stud.jpg" alt="">
                            <br><br><center><h4>Double Ended Stud</h4></center>
                        </div>
                        <div class="col-lg-3">
                            <img src="img/product/threaded/Zinc-Plated-Studs.jpg" alt="">
                            <br><br><center><h4>Zinc Plated Studs</h4></center>
                        </div>
                        <div class="col-lg-3">
                            <img src="img/product/threaded/Body-Studs.jpg" alt="">
                            <br><br><center><h4>Body Studs</h4></center>
                        </div>
                    </div>
