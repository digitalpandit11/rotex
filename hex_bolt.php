...
<div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Hex Bolt</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="bolts.php">Bolts</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Hex Bolt</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-fluid bg-light overflow-hidden my-5 px-lg-5">
        <div class="container about px-lg-0">
            <div class="row g-0 mx-lg-0">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img class="mt-2" src="img/product1/HEX BOLTS/hb2.webp" width="100%" alt="">
                    </div>
                    <div class="col-md-6">
                        <img class="mt-2" src="img/product1/HEX BOLTS/hb3.webp" width="100%" alt="">
                    </div>
                </div><br>
                <div class="row">
                    <div class="col-md-6">
                        <img class="mt-2" src="img/product1/HEX BOLTS/hb4.webp" width="100%" alt="">
                    </div>
                    <div class="col-md-6">
                ...
                <br><br>
                <h3 class="text-primary">Hex Bolts Sizes & Standards</h3>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody >
                        <tr>
                            <td><center>ASME B18.2.1 Hex Bolts</center></td>
                            <td><center>3/8 inch to 3 inch</center></td>
                        </tr>
                        <tr>
                            <td><center>BS 1769 Hex Bolts</center></td>
                            <td><center>½ inch to 2 inch</center></td>
                        </tr>
                        <tr>
                            <td><center>ASME B18.2.3.6M Hex Bolts</center></td>
                            <td><center>M12 to M36</center></td>
                        </tr>
                        <tr>
                            <td><center>ASME B18.2.3.7M Hex Bolts</center></td>
                            <td><center>M16 to M36</center></td>
                        </tr>
                        <tr>
                            <td><center>DIN 6914 Hex Bolts</center></td>
                            <td><center>M16 to M36</center></td>
                        </tr>
                        <tr>
                            <td><center>ISO 7412 Hex Bolts</center></td>
                            <td><center>M16 to M36</center></td>
                        </tr>
                        <tr>
                            <td><center>UNI 5712 Hex Bolts</center></td>
                            <td><center>M16 to M36</center></td>
                        </tr>
                        <tr>
                            <td><center>DIN-EN 14399-4 Hex Bolts</center></td>
                            <td><center>M16 to M36</center></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <h4 class="mb-2">Application & Uses Of Hex Bolt</h4>
                        <ul>
                            <li class="mb-2">Hex Bolt used in Petroleum Industry</li>
                            <li class="mb-2">Hex Bolt used in Aerospace Industry</li>
                            <li class="mb-2">Hex Bolt used in Chemical Industry</li>
                            <li class="mb-2">Hex Bolt used in oil & Gas Industry</li>
                            <li class="mb-2">Hex Bolt used in Nuclear Energy Sector</li>
                            <li class="mb-2">Hex Bolt used in automotive industries</li>
                        </ul>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <ul>
                            ...
                            <li><a href="threaded.php"><b><u>Threaded Rods</u></b></a>
                                <ul>
                                    ...
                                    <li><a href="half_threaded.php">Half Threaded Stud</a></li>
                                </ul>
                            </li>
