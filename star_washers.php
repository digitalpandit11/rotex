...
<div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Star Washers</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="product.php">Products</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Star Washers</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-9 ps-lg-2" style="min-height: 400px;">
                    ...
                    <table class=" table table-bordered ">
                        <tbody>
                            <tr>
                                <th><center>Star Washer Specifications</center></th>
                                <th><center>Specifications</center></th>
                            </tr>
                            <tr>
                                <th><center>Star Washers Thread Size</center></th>
                                <td><center>M160, M12, M80, M65, 1/2″, M8, M56</center></td>
                            </tr>
                            <tr>
                                <th><center>External Star Washers Thickness	</center></th>
                                <td><center>3/4IN, 6 MM</center></td>
                            </tr>
                            <tr>
                                <th><center>Standard of Internal Star Washers</center></th>
                                <td><center>DIN 127, BS 1802-1951, IS 3063-1994, ASTM, DIN, BS and all International Standards</center></td>
                            </tr>
                            <tr>
                                <th><center>Type</center></th>
                                <td><center>Internal / External Star Washers</center></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
