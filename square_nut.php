...
<div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Square Nuts</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="product.php">Products</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Square Nut</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <table class=" table table-bordered ">
                        <tbody>
                            <tr>
                                ...
                                <td><center>18-8 Ss, 4.8, 8.8, A2, A4, A2-70; A4-70; A4-80 Square Nuts</center></td>
                            </tr>
                            <tr>
